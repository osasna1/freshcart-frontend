    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.headerSection}>
          ...
          <Pressable onLongPress={() => router.push("/admin/login")} delayLongPress={800}>
            <View style={styles.logoWrap}>
              {/* Bold dark outer ring with yellow inner */}
        ...
        <Pressable
          ...
          onPress={async () => {
            await storage.multiRemove([TOKEN_KEY, CUSTOMER_KEY, ROLE_KEY]);
...
const styles = StyleSheet.create({
  container: {
    flexGrow: 1,
    backgroundColor: "#1a7a2e", // ✅ Back to green background
  ...
  logoWrap: {
    ...
    backgroundColor: "#f5c518", // ✅ Yellow icon background
  ...
  brandCart: { fontSize: 36, fontWeight: "900", color: "#f5c518" }, // ✅ Yellow "Cart"
  ...
  cardAccentBar: {
    ...
    height: 5, backgroundColor: "#f5c518", // ✅ Yellow top bar on card
  },
  ...
  // ─── BUTTONS ───
  loginBtn: {
    backgroundColor: "#f5c518", // ✅ Yellow Sign In button
  ...
  registerBtn: {
    ...
    backgroundColor: "#1a7a2e", // ✅ Green Create Account button
  },
  registerBtnText: { color: "#f5c518", fontWeight: "900", fontSize: 15 }, // ✅ Yellow text on green
